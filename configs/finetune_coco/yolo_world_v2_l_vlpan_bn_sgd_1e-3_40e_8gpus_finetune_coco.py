...
METAINFO = {
    'classes': ('car', 'truck', 'person', 'bicycle', 'cyclist', 'van', 'tricycle', 'bus'),
    'palette': [
        (220, 20, 60),   # car
        (221, 11, 22),   # truck
        (221, 11, 42),   # person
...
coco_train_dataset = dict(_delete_=True,
                          ...
                          dataset=dict(
                              ...
                              data_root='data/od_city',
                              ann_file='annotations/train_annotations.json',
                              data_prefix=dict(img='train_images/'),
                              filter_cfg=dict(filter_empty_gt=False,
                                              min_size=32)),
                          class_text_path='data/texts/od_city_class_texts.json',
...
val_evaluator = dict(_delete_=True,
                     ...
                     ann_file='data/od_city/annotations/val_annotations.json',
                     metric='bbox')
